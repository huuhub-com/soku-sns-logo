...
export const SPLIT_LEFT_INITIAL_QUAD: Quad = [{x:362.04705,y:749.08041},{x:362.03555,y:981.09043},{x:522.00089,y:981.09043},{x:522.05899,y:748.88032}];
export const SPLIT_RIGHT_INITIAL_QUAD: Quad = [{x:541.38676,y:751.35515},{x:541.40976,y:981.09043},{x:728.7443,y:981.09043},{x:728.7453,y:751.35521}];
const KF_0020 = { left: SPLIT_LEFT_INITIAL_QUAD, right: SPLIT_RIGHT_INITIAL_QUAD };
